...
const seedProject = [
...

	{
		...
		deployedUrl: '',
		title: 'Roster Management CLI app',
		description: 'A CLI ap for an owner or manager to create, view or modify their employee roster.',
		technology: 'Node.js, SQL, MySQL, inquirer.js, JavaScript, CSS, HTML',
		collaborators: [{
			name: 'Benjamin Harris',
			gitHubUrl: 'https://github.com/harben31'
		}]
